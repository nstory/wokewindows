...
PERSONNEL_ORDERS_JSONL=data/personnel_orders.jsonl
...
$(PERSONNEL_ORDERS_JSONL):
	mkdir -p data && wget 'https://wokewindows-data.s3.amazonaws.com/personnel_orders/articles.jsonl' -O $@
...
.PHONY: import-personnel-orders
import-personnel-orders: $(PERSONNEL_ORDERS_JSONL)
	bundle exec rails r ./scripts/import_articles.rb $(PERSONNEL_ORDERS_JSONL)
